...
<div class="main-area"><main class="page-content">
    <div class="page-header d-flex align-items-center justify-content-between">
        <div>
            <h1 class="page-title">Thông Báo Nhân Viên</h1>
            <p class="page-subtitle">Gửi thông báo nội bộ đến nhân viên</p>
        </div>
        <button class="btn-primary-custom" data-bs-toggle="modal" data-bs-target="#modalStaffNotif">
...
<div class="modal fade" id="modalStaffNotif" tabindex="-1">
    <div class="modal-dialog"><div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Gửi Thông Báo Nhân Viên</h5><button class="btn-close" data-bs-dismiss="modal"></button></div>
        <div class="modal-body">
            <div class="mb-3"><label class="form-label">Gửi đến</label><input type="text" class="form-control" placeholder="Tất cả nhân viên"></div>
